...
/**
 * An object representing the state parameter passed into this application from the Drive UI integration (i.e. Open With
 * or Create New). Required for Gson to deserialize the JSON into POJO form.
 */
public class State {
    /**
