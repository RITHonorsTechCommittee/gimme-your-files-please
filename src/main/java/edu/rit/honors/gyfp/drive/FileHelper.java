...
public interface FileHelper {
     ...
     *
     * @return a list of the immediate children of file. if file has no no children, return null
     */
     ...
     *
     * @return a reference to the File's parent. if file has no parent, return null
     */
    public
    @Nullable
     ...
     *
     * @return true if the user was successfully removed from the file; else false
     */
     ...
     *         The file to check
     *
     * @return True, if the file is a directory that has children. False, if the file is not a directory, or has no
     * children
     */
